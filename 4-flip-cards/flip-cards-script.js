(function () {
    ...
    flipCards.forEach((fCard) => {
        const reversFront = fCard.querySelector(".revers-front");
        const reversBack = fCard.querySelector(".revers-back");
        reversFront.addEventListener("click", flipped);
        reversBack.addEventListener("click", flipped);
    });
